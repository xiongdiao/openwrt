...
#ifdef RTMP_MAC_PCI
#ifdef MT7663
#define MAX_EEPROM_BIN_FILE_SIZE	1536
#else
...
#if defined(MT7663)
#define TX_PATH_NUM 2
#define RX_PATH_NUM 2
...
BOOLEAN rtmp_ee_flash_eeprom_default_file_path(struct _RTMP_ADAPTER *pAd, PUCHAR *path);
