...
#define AP_DRIVER_VERSION			"6.0.2.0"
...
#if (KERNEL_VERSION(4, 4, 0) <= LINUX_VERSION_CODE) && defined(CONFIG_ARCH_MT7622)
...
#if ((KERNEL_VERSION(2, 5, 51) > LINUX_VERSION_CODE) || (KERNEL_VERSION(2, 6, 18) < LINUX_VERSION_CODE))
