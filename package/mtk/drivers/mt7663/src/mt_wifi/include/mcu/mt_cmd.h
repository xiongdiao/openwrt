...
#ifdef SCS_FW_OFFLOAD
	EXT_EVENT_ID_SCS_FEATURE_CTRL = 0x82,
#endif
...
typedef struct GNU_PACKED _EXT_CMD_TXBF_FBRPT_DBG_INFO_T {
	...
	UINT8 ucBandIdx;
	UINT8 ucWlanIdx;
	UINT8 ucPollPFMUIntrStatTimeOut;
	UINT8 ucFbRptDeQInterval;
	UINT8 ucPFMUUpdateEn;
	UINT8 ucReserved[9];
...
typedef enum {
	...
	TX_IQM = 0x400,
	TX_PGA = 0x800,
	TX_DPD_FLATNESS_CAL = 0x10000000,
	PRE_CAL = 0x20000000,
	CAL_ALL = 0x80000000,
} CAL_ITEM_IDX;
...
typedef struct GNU_PACKED _EXT_EVENT_THERMAL_SENSOR_ITEM_INFO_T {
	UINT8  u1ThermalCategory;
	UINT8  u1ThermoItemsNum;
	UINT8  au1Reserved[2];
...
typedef struct GNU_PACKED _CMD_THERMAL_ITEM_INFO_T {
	UINT8  u1PowerCtrlFormatId;
	UINT8  u1Reserved[3];
} CMD_THERMAL_ITEM_INFO_T, *P_CMD_THERMAL_ITEM_INFO_T;
...
#else /* defined(MT7663) || defined(MT7626) */
...
typedef struct GNU_PACKED _EXT_EVENT_RDD_REPORT_T {
	UINT8 rd_rpt_mode; /*0: Only report radar detected;   1:  Add parameter reports*/
	UINT8 rdd_idx;
	UINT8 lng_pls_detected;
	UINT8 prd_pls_detected;
	UINT8 ucLPBNum;
	UINT8 ucPPBNum;
	UINT8 ucLPBPeriodValid;
	UINT8 ucLPBWidthValid;
	UINT8 ucPRICountM1;
	UINT8 ucPRICountM1TH;
	UINT8 ucPRICountM2;
	UINT8 ucPRICountM2TH;
...
typedef struct GNU_PACKED _EXT_CMD_VOW_FEATURE_CTRL_T {
	...
	/* DW#9 */
#ifdef RT_BIG_ENDIAN
	UINT32     u4ResreveBackupValue:28;
...
typedef enum _ENUM_RX_AT_FEATURE_SUB_FIELD_T {
	...
	ENUM_RX_AT_FEATURE_SUB_TYPE_WTBL_ADM_EN = 3,
	ENUM_RX_AT_FEATURE_SUB_TYPE_WTBL_ADM_MODE = 4,
...
typedef struct GNU_PACKED _RX_AT_FEATURE_SUB_FIELD_CTRL_T {
	...
	BOOLEAN                 fgRxWtblAdmTimeEn;
	UINT8                   ucRxWtblAdmTimeMode;
...
INT32 MtCmdBcnV2OffloadSet(struct _RTMP_ADAPTER *pAd, CMD_BCN_OFFLOAD_T_V2 *bcn_offload_v2);
#endif
...
INT32 MtCmdSetGroupPreCal_7663(struct _RTMP_ADAPTER *pAd, UINT16 idx, UINT32 length);
INT32 MtCmdSetDpdFlatnessCal_7663(struct _RTMP_ADAPTER *pAd, UINT16 idx, UINT32 length);
