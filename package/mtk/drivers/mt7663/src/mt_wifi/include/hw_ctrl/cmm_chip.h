...
enum PHY_CAP {
	...
	fPHY_CAP_BW40 = (1 << 7),
	fPHY_CAP_BW80 = (1 << 8),
	fPHY_CAP_BW160NC = (1 << 9),
	fPHY_CAP_BW160C = (1 << 10),
	fPHY_CAP_BW20_242TONE = (1 << 11),
	fPHY_CAP_TX_DOPPLER = (1 << 12),
	fPHY_CAP_RX_DOPPLER = (1 << 13),
	fPHY_CAP_ER_SU = (1 << 14),
	fPHY_CAP_HE_UL_MU = (1 << 15),
	fPHY_CAP_DUALPHY = (1 << 16),
};
...
#endif
	UCHAR* (*get_bin_image_file)(struct _RTMP_ADAPTER *pAd);
...
#define SNR_FORMULA4		3	/* for MT7603 */
	...
	*/
	...
	/*
	 * Define configurable Probe Response Times
	 * 1: Support Multi-Sta better
	 * 2: Default
	 */
	UINT8 ProbeRspTimes;
	/*
...
#define KTHREAD_METHOD 3
	...
	struct hif_pci_ring_layout hif_pci_ring_layout;
