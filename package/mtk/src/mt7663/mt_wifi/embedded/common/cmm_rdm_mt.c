	...
	IN PRTMP_ADAPTER	pAd)
{
	...
	pDfsParam->pls_width_max = 110; /* unit: us */
	pDfsParam->pls_pwr_max = -10; /* unit: dBm */
	pDfsParam->pls_pwr_min = -80; /* unit: dBm */

	pDfsParam->fcc_lpn_min = 8;

	pDfsParam->pri_min_stgr = 800; /* unit: us */
	pDfsParam->pri_max_stgr = 3360; /* unit: us */
	pDfsParam->pri_min_cr = 128; /* unit: us */
	pDfsParam->pri_max_cr = 5200; /* unit: us */
	...
	/* FCC-1/JP-1 */
	pDfsParam->sw_radar_type[0].rt_det = 0;
	pDfsParam->sw_radar_type[0].rt_en = 1;
	pDfsParam->sw_radar_type[0].rt_stgr = 0;
	pDfsParam->sw_radar_type[0].rt_crpn_min = 8;
	pDfsParam->sw_radar_type[0].rt_crpn_max = 18;
	pDfsParam->sw_radar_type[0].rt_crpr_min = 28;
	pDfsParam->sw_radar_type[0].rt_pw_min = 0;
	pDfsParam->sw_radar_type[0].rt_pw_max = 13;
	pDfsParam->sw_radar_type[0].rt_pri_min = 1418;
	pDfsParam->sw_radar_type[0].rt_pri_max = 1438;
	pDfsParam->sw_radar_type[0].rt_crbn_min = 1;
	pDfsParam->sw_radar_type[0].rt_crbn_max = 1;
	pDfsParam->sw_radar_type[0].rt_stg_pn_min = 0;
	pDfsParam->sw_radar_type[0].rt_stg_pn_max = 0;
	pDfsParam->sw_radar_type[0].rt_stg_pr_min = 0;
	/* FCC-2 */
	pDfsParam->sw_radar_type[1].rt_det = 0;
	pDfsParam->sw_radar_type[1].rt_en = 1;
	pDfsParam->sw_radar_type[1].rt_stgr = 0;
	pDfsParam->sw_radar_type[1].rt_crpn_min = 12;
	pDfsParam->sw_radar_type[1].rt_crpn_max = 29;
	pDfsParam->sw_radar_type[1].rt_crpr_min = 28;
	pDfsParam->sw_radar_type[1].rt_pw_min = 0;
	pDfsParam->sw_radar_type[1].rt_pw_max = 17;
	pDfsParam->sw_radar_type[1].rt_pri_min = 140;
	pDfsParam->sw_radar_type[1].rt_pri_max = 240;
	pDfsParam->sw_radar_type[1].rt_crbn_min = 1;
	pDfsParam->sw_radar_type[1].rt_crbn_max = 1;
	pDfsParam->sw_radar_type[1].rt_stg_pn_min = 0;
	pDfsParam->sw_radar_type[1].rt_stg_pn_max = 0;
	pDfsParam->sw_radar_type[1].rt_stg_pr_min = 0;
	/* FCC-3 */
	pDfsParam->sw_radar_type[2].rt_det = 0;
	pDfsParam->sw_radar_type[2].rt_en = 1;
	pDfsParam->sw_radar_type[2].rt_stgr = 0;
	pDfsParam->sw_radar_type[2].rt_crpn_min = 8;
	pDfsParam->sw_radar_type[2].rt_crpn_max = 18;
	pDfsParam->sw_radar_type[2].rt_crpr_min = 28;
	pDfsParam->sw_radar_type[2].rt_pw_min = 0;
	pDfsParam->sw_radar_type[2].rt_pw_max = 22;
	pDfsParam->sw_radar_type[2].rt_pri_min = 190;
	pDfsParam->sw_radar_type[2].rt_pri_max = 510;
	pDfsParam->sw_radar_type[2].rt_crbn_min = 1;
	pDfsParam->sw_radar_type[2].rt_crbn_max = 1;
	pDfsParam->sw_radar_type[2].rt_stg_pn_min = 0;
	pDfsParam->sw_radar_type[2].rt_stg_pn_max = 0;
	pDfsParam->sw_radar_type[2].rt_stg_pr_min = 0;
	/* FCC-4 */
	pDfsParam->sw_radar_type[3].rt_det = 0;
	pDfsParam->sw_radar_type[3].rt_en = 1;
	pDfsParam->sw_radar_type[3].rt_stgr = 0;
	pDfsParam->sw_radar_type[3].rt_crpn_min = 6;
	pDfsParam->sw_radar_type[3].rt_crpn_max = 16;
	pDfsParam->sw_radar_type[3].rt_crpr_min = 28;
	pDfsParam->sw_radar_type[3].rt_pw_min = 0;
	pDfsParam->sw_radar_type[3].rt_pw_max = 32;
	pDfsParam->sw_radar_type[3].rt_pri_min = 190;
	pDfsParam->sw_radar_type[3].rt_pri_max = 510;
	pDfsParam->sw_radar_type[3].rt_crbn_min = 1;
	pDfsParam->sw_radar_type[3].rt_crbn_max = 1;
	pDfsParam->sw_radar_type[3].rt_stg_pn_min = 0;
	pDfsParam->sw_radar_type[3].rt_stg_pn_max = 0;
	pDfsParam->sw_radar_type[3].rt_stg_pr_min = 0;
	/* FCC-6 */
	pDfsParam->sw_radar_type[4].rt_det = 0;
	pDfsParam->sw_radar_type[4].rt_en = 1;
	pDfsParam->sw_radar_type[4].rt_stgr = 0;
	pDfsParam->sw_radar_type[4].rt_crpn_min = 9;
	pDfsParam->sw_radar_type[4].rt_crpn_max = 32;
	pDfsParam->sw_radar_type[4].rt_crpr_min = 28;
	pDfsParam->sw_radar_type[4].rt_pw_min = 0;
	pDfsParam->sw_radar_type[4].rt_pw_max = 13;
	pDfsParam->sw_radar_type[4].rt_pri_min = 323;
	pDfsParam->sw_radar_type[4].rt_pri_max = 343;
	pDfsParam->sw_radar_type[4].rt_crbn_min = 1;
	pDfsParam->sw_radar_type[4].rt_crbn_max = 32;
	pDfsParam->sw_radar_type[4].rt_stg_pn_min = 0;
	pDfsParam->sw_radar_type[4].rt_stg_pn_max = 0;
	pDfsParam->sw_radar_type[4].rt_stg_pr_min = 0;
	/* ETSI-1 */
	pDfsParam->sw_radar_type[5].rt_det = 0;
	pDfsParam->sw_radar_type[5].rt_en = 1;
	pDfsParam->sw_radar_type[5].rt_stgr = 0;
	pDfsParam->sw_radar_type[5].rt_crpn_min = 6;
	pDfsParam->sw_radar_type[5].rt_crpn_max = 10;
	pDfsParam->sw_radar_type[5].rt_crpr_min = 28;
	pDfsParam->sw_radar_type[5].rt_pw_min = 0;
	pDfsParam->sw_radar_type[5].rt_pw_max = 17;
	pDfsParam->sw_radar_type[5].rt_pri_min = 990;
	pDfsParam->sw_radar_type[5].rt_pri_max = 5010;
	pDfsParam->sw_radar_type[5].rt_crbn_min = 1;
	pDfsParam->sw_radar_type[5].rt_crbn_max = 1;
	pDfsParam->sw_radar_type[5].rt_stg_pn_min = 0;
	pDfsParam->sw_radar_type[5].rt_stg_pn_max = 0;
	pDfsParam->sw_radar_type[5].rt_stg_pr_min = 0;
	/* ETSI-2 */
	pDfsParam->sw_radar_type[6].rt_det = 0;
	pDfsParam->sw_radar_type[6].rt_en = 1;
	pDfsParam->sw_radar_type[6].rt_stgr = 0;
	pDfsParam->sw_radar_type[6].rt_crpn_min = 9;
	pDfsParam->sw_radar_type[6].rt_crpn_max = 32;
	pDfsParam->sw_radar_type[6].rt_crpr_min = 28;
	pDfsParam->sw_radar_type[6].rt_pw_min = 0;
	pDfsParam->sw_radar_type[6].rt_pw_max = 27;
	pDfsParam->sw_radar_type[6].rt_pri_min = 615;
	pDfsParam->sw_radar_type[6].rt_pri_max = 5010;
	pDfsParam->sw_radar_type[6].rt_crbn_min = 1;
	pDfsParam->sw_radar_type[6].rt_crbn_max = 1;
	pDfsParam->sw_radar_type[6].rt_stg_pn_min = 0;
	pDfsParam->sw_radar_type[6].rt_stg_pn_max = 0;
	pDfsParam->sw_radar_type[6].rt_stg_pr_min = 0;
	/* ETSI-3 */
	pDfsParam->sw_radar_type[7].rt_det = 0;
	pDfsParam->sw_radar_type[7].rt_en = 1;
	pDfsParam->sw_radar_type[7].rt_stgr = 0;
	pDfsParam->sw_radar_type[7].rt_crpn_min = 15;
	pDfsParam->sw_radar_type[7].rt_crpn_max = 25;
	pDfsParam->sw_radar_type[7].rt_crpr_min = 28;
	pDfsParam->sw_radar_type[7].rt_pw_min = 0;
	pDfsParam->sw_radar_type[7].rt_pw_max = 27;
	pDfsParam->sw_radar_type[7].rt_pri_min = 240;
	pDfsParam->sw_radar_type[7].rt_pri_max = 445;
	pDfsParam->sw_radar_type[7].rt_crbn_min = 1;
	pDfsParam->sw_radar_type[7].rt_crbn_max = 1;
	pDfsParam->sw_radar_type[7].rt_stg_pn_min = 0;
	pDfsParam->sw_radar_type[7].rt_stg_pn_max = 0;
	pDfsParam->sw_radar_type[7].rt_stg_pr_min = 0;
	/* ETSI-4 */
	pDfsParam->sw_radar_type[8].rt_det = 0;
	pDfsParam->sw_radar_type[8].rt_en = 1;
	pDfsParam->sw_radar_type[8].rt_stgr = 0;
	pDfsParam->sw_radar_type[8].rt_crpn_min = 12;
	pDfsParam->sw_radar_type[8].rt_crpn_max = 20;
	pDfsParam->sw_radar_type[8].rt_crpr_min = 28;
	pDfsParam->sw_radar_type[8].rt_pw_min = 0;
	pDfsParam->sw_radar_type[8].rt_pw_max = 42;
	pDfsParam->sw_radar_type[8].rt_pri_min = 240;
	pDfsParam->sw_radar_type[8].rt_pri_max = 510;
	pDfsParam->sw_radar_type[8].rt_crbn_min = 1;
	pDfsParam->sw_radar_type[8].rt_crbn_max = 1;
	pDfsParam->sw_radar_type[8].rt_stg_pn_min = 0;
	pDfsParam->sw_radar_type[8].rt_stg_pn_max = 0;
	pDfsParam->sw_radar_type[8].rt_stg_pr_min = 0;
	/* ETSI-5, 2PRI */
	pDfsParam->sw_radar_type[9].rt_det = 0;
	pDfsParam->sw_radar_type[9].rt_en = 1;
	pDfsParam->sw_radar_type[9].rt_stgr = 1;
	pDfsParam->sw_radar_type[9].rt_crpn_min = 0;
	pDfsParam->sw_radar_type[9].rt_crpn_max = 0;
	pDfsParam->sw_radar_type[9].rt_crpr_min = 0;
	pDfsParam->sw_radar_type[9].rt_pw_min = 0;
	pDfsParam->sw_radar_type[9].rt_pw_max = 14;
	pDfsParam->sw_radar_type[9].rt_pri_min = 2490;
	pDfsParam->sw_radar_type[9].rt_pri_max = 3343;
	pDfsParam->sw_radar_type[9].rt_crbn_min = 0;
	pDfsParam->sw_radar_type[9].rt_crbn_max = 0;
	pDfsParam->sw_radar_type[9].rt_stg_pn_min = 12;
	pDfsParam->sw_radar_type[9].rt_stg_pn_max = 32;
	pDfsParam->sw_radar_type[9].rt_stg_pr_min = 28;
	/* ETSI-5, 3PRI */
	pDfsParam->sw_radar_type[10].rt_det = 0;
	pDfsParam->sw_radar_type[10].rt_en = 1;
	pDfsParam->sw_radar_type[10].rt_stgr = 1;
	pDfsParam->sw_radar_type[10].rt_crpn_min = 0;
	pDfsParam->sw_radar_type[10].rt_crpn_max = 0;
	pDfsParam->sw_radar_type[10].rt_crpr_min = 0;
	pDfsParam->sw_radar_type[10].rt_pw_min = 0;
	pDfsParam->sw_radar_type[10].rt_pw_max = 14;
	pDfsParam->sw_radar_type[10].rt_pri_min = 2490;
	pDfsParam->sw_radar_type[10].rt_pri_max = 3343;
	pDfsParam->sw_radar_type[10].rt_crbn_min = 0;
	pDfsParam->sw_radar_type[10].rt_crbn_max = 0;
	pDfsParam->sw_radar_type[10].rt_stg_pn_min = 15;
	pDfsParam->sw_radar_type[10].rt_stg_pn_max = 32;
	pDfsParam->sw_radar_type[10].rt_stg_pr_min = 24;
	/* ETSI-6, 2PRI */
	pDfsParam->sw_radar_type[11].rt_det = 0;
	pDfsParam->sw_radar_type[11].rt_en = 1;
	pDfsParam->sw_radar_type[11].rt_stgr = 1;
	pDfsParam->sw_radar_type[11].rt_crpn_min = 0;
	pDfsParam->sw_radar_type[11].rt_crpn_max = 0;
	pDfsParam->sw_radar_type[11].rt_crpr_min = 0;
	pDfsParam->sw_radar_type[11].rt_pw_min = 0;
	pDfsParam->sw_radar_type[11].rt_pw_max = 14;
	pDfsParam->sw_radar_type[11].rt_pri_min = 823;
	pDfsParam->sw_radar_type[11].rt_pri_max = 2510;
	pDfsParam->sw_radar_type[11].rt_crbn_min = 0;
	pDfsParam->sw_radar_type[11].rt_crbn_max = 0;
	pDfsParam->sw_radar_type[11].rt_stg_pn_min = 18;
	pDfsParam->sw_radar_type[11].rt_stg_pn_max = 32;
	pDfsParam->sw_radar_type[11].rt_stg_pr_min = 28;
	/*ETSI-6, 3PRI */
	pDfsParam->sw_radar_type[12].rt_det = 0;
	pDfsParam->sw_radar_type[12].rt_en = 1;
	pDfsParam->sw_radar_type[12].rt_stgr = 1;
	pDfsParam->sw_radar_type[12].rt_crpn_min = 0;
	pDfsParam->sw_radar_type[12].rt_crpn_max = 0;
	pDfsParam->sw_radar_type[12].rt_crpr_min = 0;
	pDfsParam->sw_radar_type[12].rt_pw_min = 0;
	pDfsParam->sw_radar_type[12].rt_pw_max = 14;
	pDfsParam->sw_radar_type[12].rt_pri_min = 823;
	pDfsParam->sw_radar_type[12].rt_pri_max = 2510;
	pDfsParam->sw_radar_type[12].rt_crbn_min = 0;
	pDfsParam->sw_radar_type[12].rt_crbn_max = 0;
	pDfsParam->sw_radar_type[12].rt_stg_pn_min = 27;
	pDfsParam->sw_radar_type[12].rt_stg_pn_max = 32;
	pDfsParam->sw_radar_type[12].rt_stg_pr_min = 24;
	/* JP-2 */
	pDfsParam->sw_radar_type[13].rt_det = 0;
	pDfsParam->sw_radar_type[13].rt_en = 1;
	pDfsParam->sw_radar_type[13].rt_stgr = 0;
	pDfsParam->sw_radar_type[13].rt_crpn_min = 7;
	pDfsParam->sw_radar_type[13].rt_crpn_max = 18;
	pDfsParam->sw_radar_type[13].rt_crpr_min = 28;
	pDfsParam->sw_radar_type[13].rt_pw_min = 0;
	pDfsParam->sw_radar_type[13].rt_pw_max = 14;
	pDfsParam->sw_radar_type[13].rt_pri_min = 3836;
	pDfsParam->sw_radar_type[13].rt_pri_max = 3856;
	pDfsParam->sw_radar_type[13].rt_crbn_min = 1;
	pDfsParam->sw_radar_type[13].rt_crbn_max = 1;
	pDfsParam->sw_radar_type[13].rt_stg_pn_min = 0;
	pDfsParam->sw_radar_type[13].rt_stg_pn_max = 0;
	pDfsParam->sw_radar_type[13].rt_stg_pr_min = 0;
	/* New JP radar, JP_3 */
	pDfsParam->sw_radar_type[14].rt_det = 0;
	pDfsParam->sw_radar_type[14].rt_en = 1;
	pDfsParam->sw_radar_type[14].rt_stgr = 0;
	pDfsParam->sw_radar_type[14].rt_crpn_min = 6;
	pDfsParam->sw_radar_type[14].rt_crpn_max = 32;
	pDfsParam->sw_radar_type[14].rt_crpr_min = 28;
	pDfsParam->sw_radar_type[14].rt_pw_min = 0;
	pDfsParam->sw_radar_type[14].rt_pw_max = 110;
	pDfsParam->sw_radar_type[14].rt_pri_min = 615;
	pDfsParam->sw_radar_type[14].rt_pri_max = 5010;
	pDfsParam->sw_radar_type[14].rt_crbn_min = 1;
	pDfsParam->sw_radar_type[14].rt_crbn_max = 1;
	pDfsParam->sw_radar_type[14].rt_stg_pn_min = 0;
	pDfsParam->sw_radar_type[14].rt_stg_pn_max = 0;
	pDfsParam->sw_radar_type[14].rt_stg_pr_min = 0;
	/* New JP radar, JP_4 */
	pDfsParam->sw_radar_type[15].rt_det = 0;
	pDfsParam->sw_radar_type[15].rt_en = 1;
	pDfsParam->sw_radar_type[15].rt_stgr = 1;
	pDfsParam->sw_radar_type[15].rt_crpn_min = 0;
	pDfsParam->sw_radar_type[15].rt_crpn_max = 0;
	pDfsParam->sw_radar_type[15].rt_crpr_min = 0;
	pDfsParam->sw_radar_type[15].rt_pw_min = 0;
	pDfsParam->sw_radar_type[15].rt_pw_max = 110;
	pDfsParam->sw_radar_type[15].rt_pri_min = 15;
	pDfsParam->sw_radar_type[15].rt_pri_max = 5010;
	pDfsParam->sw_radar_type[15].rt_crbn_min = 0;
	pDfsParam->sw_radar_type[15].rt_crbn_max = 0;
	pDfsParam->sw_radar_type[15].rt_stg_pn_min = 12;
	pDfsParam->sw_radar_type[15].rt_stg_pn_max = 32;
	pDfsParam->sw_radar_type[15].rt_stg_pr_min = 28;
...
*/
/*----------------------------------------------------------------------------*/
VOID dfs_rdd_pulsedata(IN RTMP_ADAPTER * pAd, IN P_EXT_EVENT_RDD_REPORT_T pExtEventRddReport)
{
	UINT8 rddidx = 0, plsidx = 0, rdrptmode = 0;
	static UINT8 rddevtidx;
	PDFS_PARAM dfsparam = &pAd->CommonCfg.DfsParameter;

	if (!pExtEventRddReport)
		return;

	/* Restore radar pulse data */
	g_rdd_plsinfo[(rddevtidx % DFS_RDD_PULSEDATA_NUM)] = *pExtEventRddReport;
	MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("[DfsRddPulseData] rddevtidx = %d\n", rddevtidx));
	INC_RING_INDEX(rddevtidx, DFS_RDD_PULSEDATA_NUM);

	rdrptmode = pExtEventRddReport->rd_rpt_mode;
	rddidx = pExtEventRddReport->rdd_idx;

	/* No need to print radar pulse data */
	if (rdrptmode == ENUM_RDD_PULSE_DATA_OFF)
		return;

	/* Print radar pulse data if debug level is DBG_LVL_TRACE(3) */
	if (dfsparam->bNoSwitchCh != TRUE)
		return;

	/* Print radar pulse data */
	MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("RDD Pulse Data Start\n"));
	MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("RDD%d Pulse Data: MDRDY_StartTime_PulseWidth_PulsePower\n", rddidx));
	pExtEventRddReport->lng_pls_buff[plsidx].lng_strt_time =
		le2cpu32(pExtEventRddReport->lng_pls_buff[plsidx].lng_strt_time);
	pExtEventRddReport->lng_pls_buff[plsidx].lng_pls_wdth =
		le2cpu16(pExtEventRddReport->lng_pls_buff[plsidx].lng_pls_wdth);
	pExtEventRddReport->lng_pls_buff[plsidx].lng_pls_pwr =
		le2cpu16(pExtEventRddReport->lng_pls_buff[plsidx].lng_pls_pwr);

	if (pExtEventRddReport->lng_pls_detected) {

		for (plsidx = 0; plsidx < pExtEventRddReport->ucLPBNum; plsidx++) {
			MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("LongPulse_%d\t", plsidx));
			MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%d_%u_%u_%d\n",
				pExtEventRddReport->lng_pls_buff[plsidx].lng_mdrdy_flg,
				pExtEventRddReport->lng_pls_buff[plsidx].lng_strt_time,
				pExtEventRddReport->lng_pls_buff[plsidx].lng_pls_wdth,
				pExtEventRddReport->lng_pls_buff[plsidx].lng_pls_pwr));
		}

		MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("Long pulses are detected\n"));
		MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("Num of long pulses: %d\n",
			pExtEventRddReport->ucLPBNum));
		MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("LPBPeriodValid: %d\n",
			pExtEventRddReport->ucLPBPeriodValid));
		MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("LPBWidthValid: %d\n",
			pExtEventRddReport->ucLPBWidthValid));
	}


	if (pExtEventRddReport->prd_pls_detected) {

		for (plsidx = 0; plsidx < pExtEventRddReport->ucPPBNum; plsidx++) {
			MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("PeriodPulse_%d\t", plsidx));
			MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%d_%u_%u_%d\n",
				pExtEventRddReport->prd_pls_buff[plsidx].prd_mdrdy_flg,
				pExtEventRddReport->prd_pls_buff[plsidx].prd_strt_time,
				pExtEventRddReport->prd_pls_buff[plsidx].prd_pls_wdth,
				pExtEventRddReport->prd_pls_buff[plsidx].prd_pls_pwr));
		}

		MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("Periodic pulses are detected\n"));
		MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("Num of periodic pulses: %d\n",
			pExtEventRddReport->ucPPBNum));
		MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("PRICountM1/PRICountM1TH: %d/%d\n",
			pExtEventRddReport->ucPRICountM1, pExtEventRddReport->ucPRICountM1TH));
		MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("PRICountM2/PRICountM2TH: %d/%d\n",
			pExtEventRddReport->ucPRICountM2, pExtEventRddReport->ucPRICountM2TH));
	}

	MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("RDD Pulse Data End\n"));
}
...
{
	UINT8 value = 0, plsidx = 0, rddevtidx = 0;
	value = simple_strtol(arg, 0, 10);

	/* Clear ALL radar pulse data */
	if (value == 0) {
		os_zero_mem(&g_rdd_plsinfo, DFS_RDD_PULSEDATA_NUM * sizeof(EXT_EVENT_RDD_REPORT_T));
		MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("Info clear\n"));
	}
	/* Dump ALL radar pulse data */
	else if (value == 1) {
		MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("RDD Pulse Data Start\n"));
		for (rddevtidx = 0; rddevtidx < DFS_RDD_PULSEDATA_NUM; rddevtidx++) {
			MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("RDDEvtIdx %d\n", rddevtidx));
			if (!(g_rdd_plsinfo[rddevtidx].lng_pls_detected || g_rdd_plsinfo[rddevtidx].prd_pls_detected)) {
				MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("\tNo data\n"));
				continue;
			}
			MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("\tRDD%d Pulse Data: MDRDY_StartTime_PulseWidth_PulsePower\n",
				g_rdd_plsinfo[rddevtidx].rdd_idx));

			if (g_rdd_plsinfo[rddevtidx].lng_pls_detected) {

				for (plsidx = 0; plsidx < g_rdd_plsinfo[rddevtidx].ucLPBNum; plsidx++) {
					MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("\tLongPulse_%d\t", plsidx));
					MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%d_%u_%u_%d\n",
						g_rdd_plsinfo[rddevtidx].lng_pls_buff[plsidx].lng_mdrdy_flg,
						g_rdd_plsinfo[rddevtidx].lng_pls_buff[plsidx].lng_strt_time,
						g_rdd_plsinfo[rddevtidx].lng_pls_buff[plsidx].lng_pls_wdth,
						g_rdd_plsinfo[rddevtidx].lng_pls_buff[plsidx].lng_pls_pwr));
				}

				MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("\tLong pulses are detected\n"));
				MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("\tNum of long pulses: %d\n",
					g_rdd_plsinfo[rddevtidx].ucLPBNum));
				MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("\tLPBPeriodValid: %d\n",
					g_rdd_plsinfo[rddevtidx].ucLPBPeriodValid));
				MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("\tLPBWidthValid: %d\n",
					g_rdd_plsinfo[rddevtidx].ucLPBWidthValid));
			}

			if (g_rdd_plsinfo[rddevtidx].prd_pls_detected) {
				for (plsidx = 0; plsidx < g_rdd_plsinfo[rddevtidx].ucPPBNum; plsidx++) {
					MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("\tPeriodPulse_%d\t", plsidx));
					MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%d_%u_%u_%d\n",
						g_rdd_plsinfo[rddevtidx].prd_pls_buff[plsidx].prd_mdrdy_flg,
						g_rdd_plsinfo[rddevtidx].prd_pls_buff[plsidx].prd_strt_time,
						g_rdd_plsinfo[rddevtidx].prd_pls_buff[plsidx].prd_pls_wdth,
						g_rdd_plsinfo[rddevtidx].prd_pls_buff[plsidx].prd_pls_pwr));
				}

				MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("\tPeriodic pulses are detected\n"));
				MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("\tNum of periodic pulses: %d\n",
					g_rdd_plsinfo[rddevtidx].ucPPBNum));
				MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("\tPRICountM1/PRICountM1TH: %d/%d\n",
					g_rdd_plsinfo[rddevtidx].ucPRICountM1, g_rdd_plsinfo[rddevtidx].ucPRICountM1TH));
				MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("\tPRICountM2/PRICountM2TH: %d/%d\n",
					g_rdd_plsinfo[rddevtidx].ucPRICountM2, g_rdd_plsinfo[rddevtidx].ucPRICountM2TH));
			}
