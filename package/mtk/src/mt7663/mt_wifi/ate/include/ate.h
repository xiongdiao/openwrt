...
/* Wordaround for 7663E1 MU TX Hang .HECID : WHQA_00036579 */
#define MIN_AIFSN               0x2
#else
...
/* ATE RX mode */
#define ATE_RX_INATIVE               0
#define ATE_RX_SINGLE_BAND      1
#define ATE_RX_DUAL_BAND         2
#endif
...
struct _ATE_OPERATION {
	...
	INT32 (*PreCal7663)(struct _RTMP_ADAPTER *pAd, RTMP_STRING * arg);
	INT32 (*TxDPD7663)(struct _RTMP_ADAPTER *pAd, RTMP_STRING * arg);
...
#ifdef ATE_TXTHREAD
#if defined(ATE_CONCURRENT_SUPPORT)
	UCHAR isConcurrentTx;
	UCHAR isConcurrentRx;
#endif
#endif
};
