...
#ifdef MT7663
	if (IS_MT7663(pAd)) {
		pAd->MsMibBucket.RO_BAND0_PHYCTRL_STS0_OFFSET = MT7663_RO_BAND0_PHYCTRL_STS0_OFFSET;
		pAd->MsMibBucket.RO_BAND0_PHYCTRL_STS5_OFFSET = MT7663_RO_BAND0_PHYCTRL_STS5_OFFSET;
		pAd->MsMibBucket.PHY_BAND0_PHYMUX_5_OFFSET = MT7663_PHY_BAND0_PHYMUX_5_OFFSET;
	} else
#endif /* MT7663 */
	{
...
UINT8 cur_wcid_ar[MT7626_MT_WTBL_SIZE+1] = {0}, last_wcid_ar[MT7626_MT_WTBL_SIZE+1] = {0};
